...
using MovieApi.Application.Features.MediatorDesignPattern.Result.CastResults;
...
namespace MovieApi.Application.Features.MediatorDesignPattern.Handlers.CastHandler
{
    public class GetCastByIdQueryHandler : IRequestHandler<GetCastByIdQuery, GetCastByIdQueryResult>
    {
        ...
        async Task<GetCastByIdQueryResult> IRequestHandler<GetCastByIdQuery, GetCastByIdQueryResult>.Handle(GetCastByIdQuery request, CancellationToken cancellationToken)
        {
